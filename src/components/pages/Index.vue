    ...
    <section class="blog-body">
      ...
      <div v-else class="blog-list">
        <ul class="list-article">
          <li class="article"  @click="tocontent(article)" v-for="(article,index) in articleList" :key="article.id">
            ...
            <div class="article-footer">
              <span class="iconfont icon-riqi icons">
                <span class="content">{{article.post_time | formatDate('yyyy-MM-dd hh:mm:ss')}}</span>
              </span>

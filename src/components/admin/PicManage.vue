 ...
 * @LastEditTime: 2022-12-15 16:53:44
...
<template>
    <el-row style="margin-top: 50px;">
      ...
      <!-- 点击图片能放大查看 -->
    <el-dialog  :title="'查看图片'" centered :width="1200" :destroyOnClose="true" :visible="visibleScaleBig"
      :maskClosable="true" @cancel="visibleScaleBig=flase">

      <template slot="footer">
        <el-button key="cancelScaleBig" @click="visibleScaleBig=flase">取消</el-button>
      </template>
